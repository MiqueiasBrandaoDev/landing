  ...
  return (
    ...
    >
      <body>
        ...
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-KZJCH499Y4"
        ...
        <Script id="meta-pixel" strategy="afterInteractive">
          {`
            ...
            fbq('init', '1344919667535954');
            fbq('track', 'PageView');
          `}
        </Script>
        <noscript>
          <img height="1" width="1" style={{display:"none"}}
            src="https://www.facebook.com/tr?id=1344919667535954&ev=PageView&noscript=1"
          />
        </noscript>
      </body>
    </html>
