...
const itens = [
  {
    ...
    desc: "Protocolo de 50 páginas con todo lo que necesitas para prescribir Fullbody con seguridad y base científica. Desde los mecanismos fisiológicos hasta la periodización práctica.",
    valor: null,
    destaque: true,
  },
  {
    ...
    desc: "Modelos listos para completar y entregar a tu alumno desde mañana. Formato editable (Google Sheets / Excel). Adapta para cada cliente en minutos.",
    valor: "$15.000 COP",
    destaque: false,
  },
  {
    ...
    desc: "E-book con las directrices más actuales de la ciencia para prescripción de hipertrofia. Referencias reales, lenguaje práctico.",
    valor: "$10.000 COP",
    destaque: false,
  },
  {
    ...
    desc: "Protocolo paso a paso para evaluar cada alumno antes de prescribir. Nunca más prescripes sin datos.",
    valor: null,
    destaque: false,
  },
  {
    ...
    desc: "El sistema completo para programar meses de entrenamiento Fullbody sin repetir la misma rutina dos veces.",
    valor: null,
    destaque: false,
  },
  {
